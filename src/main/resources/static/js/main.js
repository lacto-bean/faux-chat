...
var username = null;
var chatId = randomString(24);
var otherChatId = chatId;
...
function onConnected() {
    ...
    stompClient.send("/app/chat.addUser/" + chatId,
        {},
        JSON.stringify({sender: username, type: 'JOIN', userId: chatId})
    )
...
function sendMessage(event) {
    ...
    if(messageContent && stompClient) {
        ...
        stompClient.send("/app/chat.sendMessage/" + otherChatId, {}, JSON.stringify(chatMessage));
        messageInput.value = '';
    }
    event.preventDefault();
}
